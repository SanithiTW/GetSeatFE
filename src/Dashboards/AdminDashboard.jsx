...
const BookingsView = () => {
    ...
    const loadBookings = async () => {
        ...
        for (const docSnap of snap.docs) {
            ...
            // GET PASSENGER
            const passengerRef = doc(databaseb, "passengers", data.passengerId);
            ...
            // GET SCHEDULE
            const scheduleRef = doc(databaseb, "schedules", data.scheduleId);
            ...
            if (scheduleSnap.exists()) {
                ...
                const sch = scheduleSnap.data();

                route = `${sch.departure} → ${sch.arrival}`;
                bus = `${sch.busNumber} (${sch.busModel})`;
            }
    ...
    try {
        ...
        await fetch("http://localhost:8080/api/bookings/updateStatus", {
            method: "POST",
    ...
    onClick={() => updateStatus(b.id,"reserved")}
